...
1. **Download XAMPP:** Visit the official website of Apache Friends [here](https://www.apachefriends.org/index.html) and download the appropriate XAMPP installer for your operating system (Windows, macOS, Linux).
...
To start a website using XAMPP, follow these steps:
...
- They will make an application to Teacher for organizing an event along with requesting a time slot and venue.
- Teacher will verify and review the file and will pass it to the Principal.
- Principal will finally give a response to the students.
