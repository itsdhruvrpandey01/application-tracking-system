...
<body>
    <div class="fixed-top">
        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <a class="navbar-brand" href="#home">Food Wise </a>
        ...
        <div class="cont-sec">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p>Contact No : <a href="tel: +919372660978">+91 98659****59</a></p>
                    </div>
                    <div class="col-lg-6">
                        <div class="social">
                ...
                <div class="row">
                    <div class="col-lg-6 align-item-center">
                        <div class="home-info">
                            ...
                            <h2>We <span>Can do food donation system</span> manage wastage for needy peoples</h2>
                            <p>Food donation system is a process usually led by food donation organizations that are collecting food from businesses and individuals or from the ones with excess of goods, storage it, distribute it to the food banks and finally redirect it towards people in community that have a deficit of particular goods. Food donation system is, therefore, a part of charitable activities usually organized by civil society organizations sometimes supported by state or local governments..</p>
                            <div class="buttons">
                    ...
                    <div class="col-lg-6 order-first order-lg-last">
                        <div class="img-sec">
                            <img src="img/Indian.jpeg" alt="home-image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="don-sec" id="donation">
        <div class="container">
            <div class="heading">
                <h2>We Manage food or Donation like..</h2>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="don-box">
